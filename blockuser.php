            ...
            <div id="content">
                ...
                <div class="error mx-auto" data-text="Fail!">Fail!</div> 
                    <div class="text-center">
                        ...
                        <p class="lead text-gray-800 mb-5">Ваш аккаунт был <span class="nubex1" style="color:#ff0000">заблокирован!</span><br>
                  Причина блокировки: нарушение пользовательского соглашения<br><br>
				Для уточнения полной причины блокировки и даты<br>
				разблокировки аккаунта напишите в техническую поддержку!<br>
				или же написав нам в группе во основную группу ВКонтакте.<br><br>
                  <br>
                  <a href="https://vk.me/no.code.tech" style="color:#ff0000" target="_blank">Техническая поддержка</a> ❤️</p>
                        <a href="/">&larr; Вернутся на главную</a>
                    </div></center>
                </div><br><br><br><br><br><br>      <?php include ('includes/modules/footer.php'); ?>
