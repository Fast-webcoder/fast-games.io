            ...
            <div id="content">
                ...
                <div class="error mx-auto" data-text="Fail!">Fail!</div> 
                    <div class="text-center">
                        ...
                        <p class="lead text-gray-800 mb-5">Ваш товар был <span class="nubex1" style="color:#ff0000">заблокирован!</span><br>
                  Причина блокировки: нарушение пользовательского соглашения<br><br>
				Для уточнения полной причины блокировки и даты<br>
				разблокировки товара напишите в технический раздел создав тикет<br>
				или же написав нам в группе во ВКонтакте.<br><br>
                  <br>
