...
<a href="https://lk.no-codes.ru" style="display: block; text-align: center;" target="_blank">
<img src="/engine/img/logo.png" alt="Описание изображения" style="max-width: 250px; height: auto; margin-top: 20px;">
</a>
    <div class="container">
        <div class="row justify-content-center">
		<div class="alert alert-info" style="margin-top: 30px;">
				На <a href="https://lk.no-codes.ru" style="color:#ff0000" target="_blank">No Code Panel</a> вас ждут товары, которые помогут вашему серверу SAMP выделиться и обрести особый шарм.
			</div>
    <div class="container">
        <div class="row justify-content-center">
