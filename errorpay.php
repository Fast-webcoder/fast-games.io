    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="error mx-auto" data-text="NO!">NO!</div> 
                    <div class="text-center">
                       
                        <p class="lead text-gray-800 mb-5">   Внутренняя ошибка. Возможные причины:<br>
                  - Неверная сумма платежа.<br>
                  - Не верный ID платежа.<br>
                  - Данный счет уже оплачен.<br>
                  - Платеж был отменен.<br>
                  <br>
                  Если здесь нет выявленной вами причины, то обратитесь в <a href="https://vk.me/no.code.tech" style="color:#ff0000" target="_blank">Службу поддежрки</a> ❤️</p>
